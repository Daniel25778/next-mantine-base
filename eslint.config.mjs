...
export default defineConfig([
  ...
  {
    files: [
      '**/*.story.*', // .story.ts .story.tsx .story.js .story.jsx etc
      '**/*.stories.*' // .stories.tsx, .stories.ts, .stories.jsx, .stories.js
    ],

    languageOptions: {
      globals: {
        // Storybook globals (caso use preview.js decorators, loaders, etc.)
        story: 'readonly',
        module: 'readonly'
      }
    },
